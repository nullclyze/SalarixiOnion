...
use crate::service::core::bot::{get_state, set_mutual_states, PROFILES, STATES, TASKS};
use crate::service::core::common::{get_average_coordinates_of_bots, this_is_solid_block};
use crate::service::core::extensions::{go_to, BotDefaultExt, BotInventoryExt, BotMovementExt, BotPhysicsExt, InvClick};
use crate::service::core::registry::BOT_REGISTRY;
use crate::service::generators::{randfloat, randint, randuint};
        ...
        BOT_REGISTRY
          .async_get_bot(&nickname, async |bot| match name.as_str() {
            ...
            "unite" => {
              ...
              go_to(bot.username(), average_cords.0 as i32, average_cords.2 as i32);
            }
            "turn" => {
