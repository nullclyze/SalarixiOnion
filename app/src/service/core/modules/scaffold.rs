...
use crate::service::core::bot::{kill_task, set_mutual_states, TASKS};
use crate::service::core::common::{convert_hotbar_slot_to_inventory_slot, convert_inventory_slot_to_hotbar_slot, get_block_state, this_is_solid_block};
use crate::service::core::extensions::{BotDefaultExt, BotInventoryExt, BotMovementExt, BotPhysicsExt};
...
impl ScaffoldModule {
  ...
  fn go_back(&self, username: String) {
    tokio::spawn(async move {
      loop {
        if !TASKS.get_task_activity(&username, "scaffold") {
          break;
        }
