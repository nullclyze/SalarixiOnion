...
use crate::service::core::extensions::{BotDefaultExt, BotInteractExt, BotInventoryExt, BotMovementExt};
...
impl AutoEatPlugin {
  async fn eat(&self, bot: &Client) {
    ...
    if satiety < 20 || health < 15.0 {
      ...
      if let Some(best_food) = self.get_best_food(bot, &food_list) {
        if get_state(&nickname, "can_eating") && !get_state(&nickname, "is_drinking") && !get_state(&nickname, "is_interacting") {
  ...
  fn is_food(&self, slot: usize, item: &ItemStack) -> Option<Food> {
    return Some(match item.kind() {
      ItemKind::GoldenApple => Food { slot: slot, priority: 3 },
      ItemKind::EnchantedGoldenApple => Food { slot: slot, priority: 3 },

      ItemKind::GoldenCarrot => Food { slot: slot, priority: 2 },
      ItemKind::CookedChicken => Food { slot: slot, priority: 2 },
      ItemKind::CookedBeef => Food { slot: slot, priority: 2 },
      ItemKind::CookedCod => Food { slot: slot, priority: 2 },
      ItemKind::CookedMutton => Food { slot: slot, priority: 2 },
      ItemKind::CookedPorkchop => Food { slot: slot, priority: 2 },
      ItemKind::CookedRabbit => Food { slot: slot, priority: 2 },
      ItemKind::CookedSalmon => Food { slot: slot, priority: 2 },
      ItemKind::BakedPotato => Food { slot: slot, priority: 2 },
      ItemKind::MushroomStew => Food { slot: slot, priority: 2 },
      ItemKind::RabbitStew => Food { slot: slot, priority: 2 },
      ItemKind::BeetrootSoup => Food { slot: slot, priority: 2 },
      ItemKind::PumpkinPie => Food { slot: slot, priority: 2 },

      ItemKind::Bread => Food { slot: slot, priority: 1 },
      ItemKind::Chicken => Food { slot: slot, priority: 1 },
      ItemKind::Beef => Food { slot: slot, priority: 1 },
      ItemKind::Cod => Food { slot: slot, priority: 1 },
      ItemKind::Mutton => Food { slot: slot, priority: 1 },
      ItemKind::Porkchop => Food { slot: slot, priority: 1 },
      ItemKind::Rabbit => Food { slot: slot, priority: 1 },
      ItemKind::Apple => Food { slot: slot, priority: 1 },

      ItemKind::Salmon => Food { slot: slot, priority: 0 },
      ItemKind::TropicalFish => Food { slot: slot, priority: 0 },
      ItemKind::Potato => Food { slot: slot, priority: 0 },
      ItemKind::ChorusFruit => Food { slot: slot, priority: 0 },
      ItemKind::MelonSlice => Food { slot: slot, priority: 0 },
      ItemKind::SweetBerries => Food { slot: slot, priority: 0 },
      ItemKind::GlowBerries => Food { slot: slot, priority: 0 },
      ItemKind::Carrot => Food { slot: slot, priority: 0 },
      ItemKind::Beetroot => Food { slot: slot, priority: 0 },
      ItemKind::DriedKelp => Food { slot: slot, priority: 0 },
      ItemKind::Cookie => Food { slot: slot, priority: 0 },
